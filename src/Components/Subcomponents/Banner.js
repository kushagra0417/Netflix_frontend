...
function Banner() {
    ...
    return (
        <div>
            <header className="home-banner" style={{
                ...
                <div className="home-banner-contents">
                    ...
                    <div className="home-banner-btns">
                        ...
                        <button className="home-banner-btn" onClick={() => { M.Modal.getInstance(infoModal.current).open() }}>More info</button>
                    </div>
            ...
            <div id="modal1" className=" banner-modal modal" ref={infoModal} >
                ...
                <div className=" modal-footer foot">
                    <button className="modal-close waves-effect waves btn-flat"
                        style={{ color: "white" }}
                        onClick={() => { M.Modal.getInstance(infoModal.current).close() }}> Close
                    </button>
                </div>
            </div>
        </div>
